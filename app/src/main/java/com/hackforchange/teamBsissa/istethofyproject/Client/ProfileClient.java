...
import com.hackforchange.teamBsissa.istethofyproject.ClientSessionManager;
...
import com.hackforchange.teamBsissa.istethofyproject.recordings.DBHelper;
import com.hackforchange.teamBsissa.istethofyproject.recordings.DBHelperHeart;
...
public class ProfileClient extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageuser.setClipToOutline(true);
        ...
        dbHelperHeart = new DBHelperHeart(getApplicationContext());
        ...
        valider.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                showDialog();
                Future uploading = Ion.with(ProfileClient.this)
                        .load(GlobalUrl.url + "/clientprofileimage/'" + sharedPreferences.getString("id", "") + "'")
                        ...
                        .setCallback(new FutureCallback<com.koushikdutta.ion.Response<String>>() {
                            ...
                            public void onCompleted(Exception e, com.koushikdutta.ion.Response<String> result) {
                                try {
                                    ...
                                    editor.apply();
                                    Intent intent = new Intent(ProfileClient.this, ProfileClient.class);
                                    ProfileClient.this.startActivity(intent);
        ...
        firstname.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder mbuilder = new AlertDialog.Builder(ProfileClient.this);
                ...
                menchere.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (!mvaleur.getText().toString().isEmpty()) {
                            ...
                            String server_url = GlobalUrl.url + "/updatenomclient/" + id + "/" + mvaleur.getText().toString() + "";
                            ...
                            MySegleton.getmInstance(ProfileClient.this).addTorequestque(stringRequest);


                        } else {
                            Toast.makeText(ProfileClient.this, "nn 3abi se3a bb yehdik", Toast.LENGTH_SHORT).show();
                ...
                menchere.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (!mvaleur.getText().toString().isEmpty()) {
                            ...
                            String id = sharedPreferences.getString("id", "");
                            String server_url = GlobalUrl.url + "/updateprenomclient/" + id + "/" + mvaleur.getText().toString() + "";
                            StringRequest stringRequest = new StringRequest(Request.Method.POST, server_url,
                ...
                menchere.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (!mvaleur.getText().toString().isEmpty()) {
                            ...
                            String id = sharedPreferences.getString("id", "");
                            String server_url = GlobalUrl.url + "/updatetelclient/" + id + "/" + mvaleur.getText().toString() + "";
                            StringRequest stringRequest = new StringRequest(Request.Method.POST, server_url,
                ...
                menchere.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (!mvaleur.getText().toString().isEmpty()) {
                            ...
                            String id = sharedPreferences.getString("id", "");
                            String server_url = GlobalUrl.url + "/updateemailclient/" + id + "/" + mvaleur.getText().toString() + "";
                            StringRequest stringRequest = new StringRequest(Request.Method.POST, server_url,
                ...
                menchere.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (!mvaleur.getText().toString().isEmpty()) {
                            ...
                            String id = sharedPreferences.getString("id", "");
                            String server_url = GlobalUrl.url + "/updatepasswordclient/" + id + "/" + mvaleur.getText().toString() + "";
                            StringRequest stringRequest = new StringRequest(Request.Method.POST, server_url,
        ...
        region.setText(sharedPreferences.getString("region", ""));
        ...
        reclamation.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    Toast.makeText(ProfileClient.this,
        ...
        Logout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                editor.apply();
                editor.commit();
                dbHelper.removeItemWith();
                dbHelperHeart.removeItemWith();
                Intent i = new Intent(ProfileClient.this, LoginActivity.class);
                startActivity(i);
            }
        });
        ...
        bottomNavigationView.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.nav_home:
                        Intent intent = new Intent(ProfileClient.this, HomeClient.class);
                        startActivity(intent);
                        overridePendingTransition(0, 0);
                        break;

                    case R.id.nav_message:
                        Intent intent1 = new Intent(ProfileClient.this, ChatClient.class);
                        startActivity(intent1);
                        overridePendingTransition(0, 0);
                        break;

                    case R.id.nav_tip:
                        Intent intent2 = new Intent(ProfileClient.this, HistoriqueClient.class);
                        startActivity(intent2);
                        overridePendingTransition(0, 0);
                        break;

                    case R.id.nav_hospital:
                        Intent intent3 = new Intent(ProfileClient.this, Client_localisation.class);
                        startActivity(intent3);
                        overridePendingTransition(0, 0);
                        break;

                    case R.id.nav_profile:
                        Intent intent4 = new Intent(ProfileClient.this, ProfileClient.class);
