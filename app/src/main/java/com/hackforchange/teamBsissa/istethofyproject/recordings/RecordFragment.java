...
public class RecordFragment extends Fragment implements IACRCloudListener {
            ...
            if (j2 == 0) {
                ...
                if (metadata.has("streams")) {
                    ...
                    for (int i = 0; i < musics.length(); i++) {
                        ...
                        tres = tres + (i + 1) + "" + title + "    Channel Id " + channelId + "\n";
                    }
                }
               ...
               // tres = "No result found ! Share the recording with your doctor !";
    ...
    public void addresult(String b) {
        ...
        if (sharedPreferences.getString("role", "").equals("1")) {
            String server_url = GlobalUrl.url + "/addlungsresult/" + 1 + "/" + sharedPreferences.getString("id", "") + "/" + b + "";
        ...
        if (sharedPreferences.getString("role", "").equals("0")) {
            String server_url = GlobalUrl.url + "/addlungsresult/" + 0 + "/" + sharedPreferences.getString("id", "") + "/" + b + "";
            String str = server_url.replaceAll(" ", "%20");
            StringRequest stringRequest = new StringRequest(Request.Method.POST, str,
