 ...
 * Use the {@link doctorlist#newInstance} factory method to
...
public class doctorlist extends Fragment {
     ...
     */
    public static doctorlist newInstance(int position) {
        doctorlist f = new doctorlist();
        Bundle b = new Bundle();
    ...
    public static class SimpleStringRecyclerViewAdapter
            extends RecyclerView.Adapter<doctorlist.SimpleStringRecyclerViewAdapter.ViewHolder> {
        ...
        @Override
        public doctorlist.SimpleStringRecyclerViewAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_item, parent, false);
            return new doctorlist.SimpleStringRecyclerViewAdapter.ViewHolder(view);
        }


        @Override
        public void onBindViewHolder(final doctorlist.SimpleStringRecyclerViewAdapter.ViewHolder holder, final int position) {
            ...
            holder.layout_item.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent i = new Intent(mActivity, DoctorDetailss.class);
                    ...
                    i.putExtra("etatDoc", mWishlistImageUri.get(position).getEtat());
    ...
    public ArrayList<Docteur> getList() {
        ...
        String server_url = GlobalUrl.url + "/getAllDoctors";
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        while (count < response.length()) {
                            try {
                                ...
                                Docteur userComm = new Docteur(jsonObject.getString("id"), jsonObject.getString("nom"), jsonObject.getString("prenom"), jsonObject.getString("email"), jsonObject.getString("tel"), jsonObject.getString("region"), jsonObject.getString("image_prof"), jsonObject.getString("adresse"), jsonObject.getString("image_cin"), jsonObject.getString("etat"));
