 ...
 */
public class DBHelperHeart extends SQLiteOpenHelper {
    ...
    public static final String DATABASE_NAME = "saved_recordings_heart.db";
    private static final int DATABASE_VERSION = 1;

    public static abstract class DBHelperItem implements BaseColumns {
        public static final String TABLE_NAME = "saved_recordings_heart";
    ...
    public DBHelperHeart(Context context) {
    ...
    public void removeItemWith() {
        SQLiteDatabase db = getWritableDatabase();
        db.delete("saved_recordings_heart", null, null);
        db.close();
    }
}
